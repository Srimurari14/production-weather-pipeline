...
from scripts.validations import validate_fact_weather_current
from scripts.validations import validate_dim_location
...
fact_weather_current.to_csv(
    'data/transformed/fact_weather_current.csv',
    index=False
)
